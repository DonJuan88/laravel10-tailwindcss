        ...
        <div class="row">
            <div class="col">
                <div class="card border-primary mb-3" >
                    ...
                    <div class=""></div>
                            <a href="<?php echo e(route('cats.create')); ?>" class="bg-emerald-700 hover:bg-emerald-500 text-white font-bold py-2 px-2 rounded-md text-sm">
                                Add New
                            </a>
                        </div>
                        <br/>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-gray-100 border-b border-gray-200 ">
                                            ...
                                            <td class="px-4 py-2 "><?php echo e($cat->catcode); ?></td>                                        
                                            <td class="px-4 py-2 "><?php echo e($cat->catname); ?></td>
                                            <td class="px-4 py-2 w-20">
                                                <form method="POST" action="<?php echo e(route('cats.destroy', $cat->id)); ?>">
                                                    <button class="rounded-md bg-blue hover:bg-blue-100 text-white font-bold  px-2 mr-2 py-1 text-sm"><a href="<?php echo e(route('cats.edit', $cat->id)); ?>">  Edit </a> </button>
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.v1.admin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\laravel10-tailwindcss\resources\views/v1/admin/cat/index.blade.php ENDPATH**/ ?>